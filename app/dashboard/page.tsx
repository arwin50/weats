      ...
      <div className="fixed top-4 left-0 z-50 flex gap-2 sm:gap-4 items-center px-2 sm:px-6 py-2 w-full max-w-full overflow-x-auto bg-transparent">
        ...
        {isOverlayVisible && (
          <>
            ...
            >
              <span className="font-bold">Resto List</span> <FaUtensils size={16} />
            </button>
            <button
            ...
            >
              <span className="font-bold">View history</span> <FaBookOpen size={16} />
            </button>
            <button
            ...
            >
              <span className="font-bold">Suggestions</span> <FaMapMarkedAlt size={16} />
            </button>
          </>
        )}
      </div>
